...
\begin{remark}
    It is impossible to make $C_c^\infty(\Omega)$ into a complete metric space such that each of the sets $C_c^\infty(K)$ is closed because of the Baire category theorem, since $C_c^\infty(K)$ has nonempty interior in $C_c^\infty(\Omega)$, but $C_c^\infty(\Omega)$ is the countable union of such spaces.
...
It is difficult to see from the definition of the inductive limit why the topology is much stronger
