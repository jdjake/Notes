...
%
natural because the spaces $\mathcal{S}^\mu_{\rho,\delta}$ are nested, increasing in $\mu$. Elements of $\mathcal{S}^\mu_{\rho,\delta}$ are called \emph{symbols} of order $\mu$, of type $(\rho,\delta)$.
