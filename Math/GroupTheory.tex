...
\epigraph{A group is a set of objects which can operate with each other. One can find them almost anywhere in mathematics, from number theory to geometric symmetry. The goal of this course is to learn and understand what properties result from the relationships inside a group. A prerequisite knowledge of Linear Algebra is required.}
\null\vfill
\vspace*{1cm}
\noindent
\hfill
