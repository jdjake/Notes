...
If a theory $\Gamma$ has only countably many symbols, we say it is {\bf axiomatic} if there is an effective procedure for determining if a given formula is an axiom, that is, if it is an element of $\Gamma$.
