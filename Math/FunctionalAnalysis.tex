...
\begin{example}
    ...
    %
    under a probabilistic interpretation, the probability that the two functions differ by more than $\varepislon$ converges to zero.
\end{example}
