...
Note that now if $0 < \lambda_1 < \lambda_2 < \dots \to \infty$, and $V$ is a balanced neighbourhood, then $\lambda_n V$ is balanced, hence containined $\lambda V$ for all $\lambda < \lambda_n$ and therefore, since $V$ is absorbing,
%
