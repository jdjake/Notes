...
In order to conclude that our $\Phi$ summability method works when $\Phi$ is the F\'{e}jer, Gauss, or Poisson kernel, it now suffices to verify the Fourier transforms of these kernels integrate to one. This is obvious for the F\'{e}jer and Gauss kernel. For the Abel kernel, it suffices to calculate
