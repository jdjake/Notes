...
I am an analyst, studying problems with techniques taken mainly from harmonic analysis, but also from probability and combinatorics. My PhD research, advised by Andreas Seeger, has focused on the study of radial Fourier multiplier operators on Euclidean space, and their analogues on compact manifolds, through an understanding of the geometry and regularity of wave propagation. I have also solved problems in geometric measure theory, investigating when `structure' occurs in random fractals of large dimension. Both projects raise interesting questions I plan to pursue in my postgraduate work, strongly connected to Dr. Christopher D. Sogge's interests in spectral geometry, harmonic analysis, and nonlinear dispersive partial differential equations, and so the opportunity to conduct research at the Johns Hopkins would be a fantastic place for me to cultivate my future research, and hopefully enrich the work of the analysis group at Johns Hopkins in return.
...
We now discuss two more concrete projects in more detail:
