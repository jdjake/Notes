...
Thus Hastad's $\delta$ test takes $X,Y$, and $z$, sets $Z = b(XY)$, choses $Z' \sim N_{1 - \delta}(Z)$, and accept if $f(X)f(Y)f(Z') = z$. This is a $(1/2, 1 - \delta/2)$ dictator vs. no notables test.
