...
\newcommand{\pard}[3][]{\left. \frac{\partial {{#1}} }{\partial {{#2}} } \right|_{{#3}}}
\newcommand{\pardnoline}[2][]{\frac{\partial {{#1}} }{\partial {{#2}} }}
\newcommand{\dpard}[3][]{\left. \frac{\delta {{#1}} }{\delta {{#2}} } \right|_{{#3}}}
\newcommand{\dpardnoline}[2][]{\frac{\delta {{#1}} }{\delta {{#2}} }}
