...
\begin{theorem}
    Fix $1 < p < 2d/(d+1)$, and suppose that the sharp local smoothing inequality
    %
...
\begin{proof}
    ...
    \begin{align*}
        ...
        &\lesssim (1/R)^{s_p - 1/p^*} C_p(h) + ( R^{1/p^*} C_p(h) ) \left( \sum_{l \neq 0} |Rl|^{-s_p p^*} \right)^{1/p^*}\\
        &= (1/R)^{s_p - 1/p^*} C_p(h) \left( 1 + \left( \sum_{l \neq 0} |l|^{-s_p p^*} \right)^{1/p^*} \right)\\
        &= (1/R)^{s_p - 1/p^*} C_p(h) \left( 1 + \left( \sum_{l \neq 0} |l|^{-s_p p^*} \right)^{1/p^*} \right) \\
        &\lesssim_p (1/R)^{s_p - 1/p^*} C_p(h).
    \end{align*}
    %
    ...
    \begin{align*}
        ...
        &\lesssim C_p(h) (1/R)^{s_p - 1/p^*} \left( \int_{-1/2}^{1/2} |e^{2 \pi i P} f|^{p^*}\; dt \right)^{1/p^*}.
    \end{align*}
    %
    Applying the endpoint local smoothing inequality, we conclude that
    %
    \begin{align*}
        \| III_R f \|_{L^{p^*}(M)} &\lesssim C_p(h) (1/R)^{s_p - 1/p^*} \| e^{2 \pi i P} f \|_{L^{p^*}_t L^{p^*}_x}\\
        &\lesssim C_p(h) (1/R)^{s_p - 1/p^*} \| f \|_{L^{p^*}_{s_p - 1/p^*}(M)},
    \end{align*}
    %
