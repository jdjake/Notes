...
Understanding the sum in Lemma \ref{lemma3} for $1 < p < p_d$ will require an understanding of the interference patterns of the functions $\chi_{x,r}$, which are supported on various annuli, but oscillate on these annuli. We will use almost orthogonality principles to understand these interference patterns.
