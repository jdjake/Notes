...
\begin{itemize}
    ...
    %
    so we should still think of $\widehat{b}_{t_0}$ as being Fourier localized to frequencies lying in the ball of radius $O(R)$ about the origin. TODO: Maybe can be more efficient for $t_0$ near one given that $\chi_{II}$ is more smooth near this value.
