...
To better understand the behaviour of the operator $II \circ Q$, we employ the Lax Parametrix $W$, writing, for $|t| \leq 1$,
%
...
We will begin by understanding the orthogonality properties of the functions $\{ {S\!}_{x_0,t_0} \}$. We calculate, using adjoints, that
%
\begin{align*}
