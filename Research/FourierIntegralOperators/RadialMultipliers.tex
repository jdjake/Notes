...
%
TODO: In particular, we know this characterization must be true in $\RR^d$, so if $K_t$ is the fundamental solution of the wave equation, then we must have that for all $1 \leq q \leq \infty$,
%
\[ \| (1 + |t|)^{(d-1)(1/q - 1/2)} K_t(x) \|_{L^q_x L^{q^*}_t} < \infty. \]
%
Is this true? TODO: Ask Andreas about this.
