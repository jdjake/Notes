...
%
\[ II_R = \int b_R(t) e^{2 \pi i t P}\; dt \] % \quad\text{and} \quad Q_R^{\text{Low}} = \int c_R(t) e^{2 \pi i t P}\; dt, \]
%
is obtained by integrating the wave propogators over times $50/R \leq |t| \leq 1/100$ and $|t| \leq 1/100$ respectively, with
%
\[ b_R(t) = \chi_{II,R}(t) R \widehat{h}(Rt) \] % \quad\text{and}\quad c_R(t) = \chi(t) \widehat{\beta}_R(t). \]
%
