...
%
\begin{align*}
    \int_{100/R \leq |t| \leq 1/100} & \int H_R(t) a(x,t,y,\xi) \beta(\xi / \lambda) \chi_\lambda^\nu(\xi) e^{2 \pi i \Phi(t,x,y,\xi)}\; d\xi\; dt\\
...
%
\begin{align*}
    \| T_R^\lambda f \|_{L^2(\RR^d)} &\lesssim \left( \int_{100/R \leq |t| \leq 1/100} H_R(t)\; dt \right) \| f^\lambda_\nu \|_{L^2(\RR^d)} \\
    &\lesssim \int_{100/R \leq |t| \leq 1/100} R \langle Rs \rangle^{-(d-1)(1/2 - 1/p)} \| f^\lambda_\nu \|_{L^2(\RR^d)}\\
    &\lesssim \| f^\lambda_\nu \|_{L^2(\RR^d)}.
\end{align*}
%
Thus $L^2$ orthogonality implies that
%
\[ \left( \sum_\nu \| T^\lambda_{R,\nu} f \|_{L^2(\RR^d)}^2 \right)^{1/2} \lesssim \| f \|_{L^2(\RR^d)}. \]
%
