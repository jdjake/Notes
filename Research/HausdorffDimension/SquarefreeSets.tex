...
\begin{example}
    Fraser and Pramanik construct a $(d-1)^{-1}$ dimensional set avoiding nontrivial solutions to a countable family of $d$ variate functions $f(x_1, \dots, x_d)$. Does our method apply to extend from the discrete scale bound?
\end{example}
