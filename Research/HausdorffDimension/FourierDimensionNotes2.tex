...
%    \end{equation}
    ...
    \begin{equation} \label{molificationdecaybound}
        |\widehat{\phi_\varepsilon}(k)| = |\widehat{\phi}(\varepsilon k)| \lesssim_T \varepsilon^{-T} |k|^{-T}.
    \end{equation}
\end{enumerate}
\end{itemize}
...
%    \end{equation}
    ...
    \end{itemize}
    %
    Since $\varepsilon_0 \leq K^{-1/\beta_0}$, \eqref{equationGGSC99124} implies that
    %
...
%
Then McDiarmid's inequality gives that
%
\[ \PP \left( |Y_\xi - \EE(Y_\xi|BLAH)| \geq t | BLAH \right) \leq 4 \exp \left(- \frac{t^2}{4K} \right). \]
%
