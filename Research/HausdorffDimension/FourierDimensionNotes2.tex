...
\[ \frac{dn - \alpha}{n - 1}. \]
%
This would give a Salem set with the same dimension as obtained in the main result of Theorem \cite{OurPaper}. We hope to ensure square root cancellation occurs by employing some decoupling bounds.
