...
\begin{proof}
    ...
    %
    Thus $P(S_r)$ is \emph{not satisfied}. But together with \eqref{equationDDVVIXXSX23}, this justifies that the hypothesis of Lemma \ref{LemmaFIOAJFOIWJ} applies. Thus $A(\alpha,\delta,s)$ is dense in $\mathcal{X}_\beta$, completing the proof.
\end{proof}
